...
public class PlayerAssistant{
	...
	**/
	...
	public void giveLife() {
		...
		if (c.pitsStatus == 1) {
			...
			//c.sendMessage("You respawn.  Try to be more careful.");
			c.isSkulled = false;
			c.skullTimer = 0;
	...
	**/
	...
	public void levelUp(int skill) {
		...
		sendFrame126("Total Lvl: "+c.totalLevel, 3984);
		switch (skill) {
		case 0:
	...
	public void useOperate(int itemId) {
		switch (itemId) {
			...
			case 1708:
			case 1706:
				//System.out.println("use operate for item " +  itemId);
				handleGlory(itemId);
			break;
			case 11283:
			case 11284:
